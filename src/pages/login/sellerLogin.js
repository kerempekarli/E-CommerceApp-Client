...
import Ram from "../../assets/indir_auto_x2 (1).jpg";
...
export default function Login() {
  ...
  const handleLogin = async () => {
    try {
      const response = await fetch("http://localhost:3232/sellers/login", {
        method: "POST",
        headers: {
  ...
  return (
    <>
      <div className="min-h-screen bg-gray-100">
        <div className="mx-auto justify-center flex max-w-5xl rounded-2xl  bg-white flex-wrap">
          <img
            className="object-contain w-2/4 p-5 h-[700px] rounded-2xl"
            alt="Rem"
            src={Ram}
          ></img>
